    ...
    (E, D) =>
      harden({
        async bootstrap(argv, vats, devices) {
          ...
          E(aliceP)
            .splitTapFaucet(pPGallery, 'gallery')
            .then(
              r =>
                log(
                  `=> the promise given by the call to alice.splitTapFaucet resolved to '${r}'`,
                ),
              err =>
                log(
                  `=> the promise given by the call to alice.splitTapFaucet was rejected '${err}''`,
                ),
            );
        },
      }),
